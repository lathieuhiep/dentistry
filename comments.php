...
<div id="comments" class="comments-area">
    ...
    <?php if ( have_comments() ) : ?>
        ...
        <h2 class="comments-title">
            ...
            <?php
            $dentistry_comments_number = get_comments_number();

            if ( '1' === $dentistry_comments_number ) :

                /* translators: %s: post title */
                printf( _x( 'One Reply to &ldquo;%s&rdquo;', 'comments title', 'dentistry' ), get_the_title() );
                ...
                /* translators: 1: number of comments, 2: post title */
                    _nx(
                        ...
                        $dentistry_comments_number,
                        'comments title',
                        'dentistry'
                    ),
                    number_format_i18n( $dentistry_comments_number ),
                    get_the_title()
                );
    ...
    ?>
        ...
        <p class="no-comments">
            <?php esc_html_e( 'Comments are closed.', 'dentistry' ); ?>
        </p>
    ...
    $dentistry_commenter        =   wp_get_current_commenter();
    $dentistry_req              =   get_option( 'require_name_email' );
    $dentistry_comments_args    =   ( $dentistry_req ? " aria-required='true'" : '' );
    ...
    comment_form( $dentistry_comments_args );
