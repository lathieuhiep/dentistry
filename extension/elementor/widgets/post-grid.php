...
class dentistry_widget_post_grid extends Widget_Base {
    ...
    public function get_name() {
        return 'dentistry-post-grid';
    }

    public function get_title() {
        return esc_html__( 'Posts Grid', 'dentistry' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options'   =>  [
                    ...
                    'author'        =>  esc_html__( 'Post Author', 'dentistry' ),
        ...
        $this->add_control(
            'column_number',
            [
                'label'     =>  esc_html__( 'Column', 'dentistry' ),
                'type'      =>  Controls_Manager::SELECT,
                'default'   =>  3,
                'options'   =>  [
                    4   =>  esc_html__( '4 Column', 'dentistry' ),
                    3   =>  esc_html__( '3 Column', 'dentistry' ),
                    2   =>  esc_html__( '2 Column', 'dentistry' ),
                    1   =>  esc_html__( '1 Column', 'dentistry' ),
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'section_style_post',
            [
                'label' => esc_html__( 'Color & Typography', 'dentistry' ),
        ...
        $this->add_control(
            'title_post_options',
            [
                'label'     =>  esc_html__( 'Title Post', 'dentistry' ),
        ...
        $this->add_control(
            ...
            [
                'label'     =>  esc_html__( 'Color Hover', 'dentistry' ),
                'type'      =>  Controls_Manager::COLOR,
                'default'   =>  '',
                'selectors' =>  [
        ...
        $this->add_control(
            ...
            [
                'label'     =>  esc_html__( 'Title Alignment', 'dentistry' ),
                'type'      =>  Controls_Manager::CHOOSE,
                'options'   =>  [
                    'left'  =>  [
                    ...
                    'justify'=> [
                        'title' =>  esc_html__( 'Justified', 'dentistry' ),
        ...
        $this->add_control(
            ...
            [
                'label'     =>  esc_html__( 'Excerpt Post', 'dentistry' ),
                'type'      =>  Controls_Manager::HEADING,
                'separator' =>  'before',
            ]
        );
        ...
        $this->add_control(
            'excerpt_alignment',
            [
                'label'     =>  esc_html__( 'Excerpt Alignment', 'dentistry' ),
                'type'      =>  Controls_Manager::CHOOSE,
                'options'   =>  [
                    'left'  =>  [
                        'title' =>  esc_html__( 'Left', 'dentistry' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new dentistry_widget_post_grid );