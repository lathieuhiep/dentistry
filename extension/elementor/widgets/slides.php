...
class dentistry_widget_slides extends Widget_Base {
    ...
    public function get_name() {
        return 'dentistry-slides';
    }

    public function get_title() {
        return esc_html__( 'Slides Theme', 'dentistry' );
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->start_controls_tab( 'background', [ 'label' => esc_html__( 'Background', 'dentistry' ) ] );

        $repeater->add_control(
            'slides_image',
            [
                'label'     =>  esc_html__( 'Image', 'dentistry' ),
        ...
        $repeater->add_control(
            'background_size',
            [
                'label'     =>  esc_html__( 'Size', 'dentistry' ),
                'type'      =>  Controls_Manager::SELECT,
                'default'   =>  'cover',
                'options'   =>  [
                    'cover'     =>  esc_html__( 'Cover', 'dentistry' ),
                    'contain'   =>  esc_html__( 'Contain', 'dentistry' ),
                    'auto'      =>  esc_html__( 'Auto', 'dentistry' ),
                ],
                'selectors' => [
        ...
        $repeater->add_control(
            'background_overlay',
            [
                'label' => esc_html__( 'Background Overlay', 'dentistry' ),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Color', 'dentistry' ),
        ...
        $repeater->start_controls_tab( 'content', [ 'label' => esc_html__( 'Content', 'dentistry' ) ] );

        $repeater->add_control(
            'heading',
            [
                'label' => esc_html__( 'Title & Description', 'dentistry' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Slide Heading', 'dentistry' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'dentistry' ),
                'show_label' => false,
            ]
        );
        ...
        $repeater->add_control(
            'button_text',
            [
                'label' => esc_html__( 'Button Text', 'dentistry' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Click Here', 'dentistry' ),
            ]
        );
        ...
        $repeater->add_control(
            'link',
            [
                'label'         =>  esc_html__( 'Link', 'dentistry' ),
                'type'          =>  Controls_Manager::URL,
                'label_block'   =>  true,
                'default'       =>  [
                    'is_external'   =>  'true',
                ],
                'placeholder'   =>  esc_html__( 'https://your-link.com', 'dentistry' ),
            ]
        );
	    ...
	    $repeater->add_control(
		    'show_content',
		    [
			    'label'         => esc_html__( 'Show Content', 'dentistry' ),
			    'type'          => Controls_Manager::SWITCHER,
			    'label_on'      => esc_html__( 'Show', 'dentistry' ),
			    'label_off'     => esc_html__( 'Hide', 'dentistry' ),
			    'return_value'  => 'yes',
			    'default'       => 'yes',
		    ]
	    );
        ...
        $repeater->start_controls_tab( 'style', [ 'label' => esc_html__( 'Style', 'dentistry' ) ] );

        $repeater->add_control(
            'custom_style',
            [
                'label' => esc_html__( 'Custom', 'dentistry' ),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'Set custom style that will only affect this specific slide.', 'dentistry' ),
            ]
        );
        ...
        $repeater->add_control(
            'horizontal_position',
            [
                'label' => esc_html__( 'Horizontal Position', 'dentistry' ),
        ...
        $repeater->add_control(
            'vertical_position',
            [
                'label' => esc_html__( 'Vertical Position', 'dentistry' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'top' => [
                    ...
                    'middle' => [
                        'title' => esc_html__( 'Middle', 'dentistry' ),
                        'icon' => 'eicon-v-align-middle',
                    ],
                    'bottom' => [
                        'title' => esc_html__( 'Bottom', 'dentistry' ),
        ...
        $repeater->add_control(
            'text_align',
            [
                'label' => esc_html__( 'Text Align', 'dentistry' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   =>  [
                    [
                        'heading' => esc_html__( 'Slider 1 Heading', 'dentistry' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'dentistry' ),
                        'button_text' => esc_html__( 'Click Here', 'dentistry' ),
                        'link' => '#'
                    ],
                    [
                        'heading' => esc_html__( 'Slider 2 Heading', 'dentistry' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'dentistry' ),
                        'button_text' => esc_html__( 'Click Here', 'dentistry' ),
                        'link' => '#'
                    ],
        ...
        $this->add_responsive_control(
            'slides_height',
            [
                'label' => esc_html__( 'Height', 'dentistry' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Slider Options', 'dentistry' ),
        ...
        $this->add_responsive_control(
            'content_max_width',
            [
                'label' => esc_html__( 'Content Width', 'dentistry' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'slides_padding',
            [
                'label' => esc_html__( 'Padding', 'dentistry' ),
        ...
        $this->add_control(
            'heading_spacing',
            [
                'label' => esc_html__( 'Spacing', 'dentistry' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'heading_color',
            [
                'label' => esc_html__( 'Text Color', 'dentistry' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Button', 'dentistry' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'button_border_width',
            [
                'label' => esc_html__( 'Border Width', 'dentistry' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Radius', 'dentistry' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_tab( 'normal', [ 'label' => esc_html__( 'Normal', 'dentistry' ) ] );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Background Color', 'dentistry' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_border_color',
            [
                'label' => esc_html__( 'Border Color', 'dentistry' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab( 'hover', [ 'label' => esc_html__( 'Hover', 'dentistry' ) ] );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'dentistry' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Arrows', 'dentistry' ),
        ...
        $this->add_control(
            'arrows_size',
            [
                'label' => esc_html__( 'Arrows Size', 'dentistry' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            'arrows_color',
            [
                'label' => esc_html__( 'Arrows Color', 'dentistry' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'arrows_color_hover',
            [
                'label' => esc_html__( 'Arrows Color Hover', 'dentistry' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'heading_style_dots',
            [
                'label' => esc_html__( 'Dots', 'dentistry' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'conditions' => [
                    'terms' => [
        ...
        $this->add_control(
            'dots_size',
            [
                'label' => esc_html__( 'Dots Size', 'dentistry' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 5,
        ...
        $this->add_control(
            'dots_color',
            [
                'label' => esc_html__( 'Dots Color', 'dentistry' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dots_color_hover',
            [
                'label' => esc_html__( 'Dots Color Hover', 'dentistry' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    ?>
        ...
        <div class="element-slides custom-owl-carousel owl-carousel owl-theme" data-settings-owl='<?php echo wp_json_encode( $data_settings_owl ); ?>'>
            ...
            foreach ( $settings['slides_list'] as $item ) :
                $dentistry_slides_link         =   $item['link'];
                            ...
                            <div class="element-slides__item--content">
                                ...
                                <?php if ( !empty( $item['button_text'] ) ) : ?>
                                    <div class="element-slides__item--link">
                                        <?php if ( !empty( $dentistry_slides_link['url'] ) ) : ?>
                                            <a href="<?php echo esc_url( $dentistry_slides_link['url'] ); ?>" <?php echo ( $dentistry_slides_link['is_external'] ? 'target="_blank"' : '' ); ?>>
...
Plugin::instance()->widgets_manager->register_widget_type( new dentistry_widget_slides );